(function(){
    ...
    angular
        .module('lotes.lote')
        .controller('RemitosActasController', RemitosActasController);
        
        RemitosActasController.$inject = ['$scope', '$state', 'moment', '$filter', '$log', '$document', '$http', '$q', '$timeout', '$mdDialog', 'remitosActasService','PROCESOS'];
        function RemitosActasController($scope, $state, moment, $filter, $log, $document, $http, $q, $timeout, $mdDialog, remitosActasService, PROCESOS) {
               ...
               activate();
                ...
                function generarActas( event ){
                    ...
                    //console.log(pkg_actas.data.codigos_barras)
                ...
                function generaSQLRemitosActas(  ){
                    ...
                    var str_sql = 'INSERT INTO US_SVIAL_SIJAI_OWNER.REMITOS_ACTAS(ID_REMITO_ACTA,ID_REMITO,NUMERO_ACTA,CODIGO_BARRAS,NOTIFICAR,CANTIDAD_FOJAS,F_AUDITORIA,ID_USUARIO_AUDITORIA)';
                    str_sql += 'VALUES(REMITOS_ACTAS_SEQ.NEXTVAL,';
                ...
                function generaDigitoVerificadorInterno56 ( cod_fiscalizacion ){
                    ...
                    for(var i = 0; i< arr_cod_fisc.length-1;i++){
